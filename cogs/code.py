...
class Code(Cog):
    ...
    async def clone(self, ctx, *, clone_url: str):
        ...
        # TODO: Add check for only allowing one session per user.
        # Create session ID
        ...
        self.bot.log.info(f"[GIT] Created new session {session}")
        ...
        self.bot.log.info(f"[GIT] [{session}] Created new volume.")
        ...
        self.bot.log.info(f"[GIT] [{session}] Clone container shutdown.")
